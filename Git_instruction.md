...
```
1. Accept Current Change - принимаем изменения из текущего коммита.
2. Accept Incoming Change - принимаем изменения из входящего коммита (сливаемого).
3. Accept Both Changes - принимаем изменения двух коммитов.
4. Comparison of changes - сравнить изменения двух коммитов. 
